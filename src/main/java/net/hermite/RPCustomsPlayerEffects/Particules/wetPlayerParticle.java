...
//Fonctions gérant la particule qui apparait sur un personnage mouillé
public class wetPlayerParticle extends Particle {
	...
	public wetPlayerParticle(World worldIn, double posXIn, double posYIn, double posZIn) {
	...
	public wetPlayerParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, int ageOffset) {
	...
	public void renderParticle(BufferBuilder worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
		...
		int i = MathHelper.clamp((int)(((float)this.particleAge + partialTicks) / (float)this.particleMaxAge * 32.0F), 0, 1);
