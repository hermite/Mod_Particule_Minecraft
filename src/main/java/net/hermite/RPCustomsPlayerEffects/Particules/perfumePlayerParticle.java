...
//Fonctions gérant la particule qui apparait sur un personnage parfumé
import net.minecraftforge.fml.relauncher.SideOnly;
import net.minecraftforge.fml.relauncher.Side;

@SideOnly(Side.CLIENT)
public class perfumePlayerParticle extends Particle {
	...
	public perfumePlayerParticle(World worldIn, double posXIn, double posYIn, double posZIn) {
		...
		//super(Minecraft.getMinecraft().getTextureManager(), worldIn, posXIn, posYIn, posZIn, 0, 0, 0);
				...
				this.particleRed = 0.80f;//((float)(Math.random() * 0.20000000298023224D) + 0.8F) * f4;
				this.particleGreen = 0.20f;//((float)(Math.random() * 0.20000000298023224D) + 1F) * f4;
				this.particleBlue = 0.47f;//((float)(Math.random() * 0.20000000298023224D) + 0.8F) * f4;
	...
	public perfumePlayerParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, int ageOffset) {
	...
	public void renderParticle(BufferBuilder worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
		...
		int i = MathHelper.clamp((int)(((float)this.particleAge + partialTicks) / (float)this.particleMaxAge * 32.0F), 0, 7);
